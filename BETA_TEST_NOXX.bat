...
echo        Hello %userName%!
echo ========================================
echo This is the beta V3 of the Noxx Tool and this is a beta test.
echo Some new features added include:
echo - A brand new page
echo - A new GUI design (which I will try to make better)
echo - New buttons for improved functionality
echo - Read Explaination button for more understanding. This is just beta; It is not completed yet *smacks her phat ass* 
echo - Feel free to delete this file after viewing or u can use for the new features~ :D
echo.
echo ========================================
echo           Next Page
echo ========================================
echo  Search for Music on YouTube
echo  Run ipconfig
echo  Is this website safe?
echo.
echo                 Support
echo ========================================
echo  Microsoft Support
echo ========================================
pause
...
echo 13. Destroy (kills Discord and tool)
echo 14. Lock PC
echo.
...
echo 19. Next Page
echo ========================================
set /p choice=Choose an option (0-19): 
...
echo           Next Page
echo ========================================
echo 1. Search for Music on YouTube
echo 2. Run ipconfig
echo 3. Is this website safe?
echo.
echo                  Support
echo ========================================
echo 4. Microsoft Support
echo 5. Back to Main Menu
echo ========================================
set /p nextChoice=Choose an option (1-5): 

if "%nextChoice%"=="1" goto search_youtube
if "%nextChoice%"=="2" goto run_ipconfig
if "%nextChoice%"=="3" goto website_safety
if "%nextChoice%"=="4" goto support
if "%nextChoice%"=="5" goto menu
...
echo           Microsoft Support
echo ========================================
echo This link will take you to an official Microsoft support page where a Microsoft worker will help you with your Windows PC.
echo Make sure when you're taken there, you are signed in and select "Home Support" or the device you're having trouble with.
echo [Link: https://support.microsoft.com/en-us/contactus]
echo Type Y to go to the support page, or N to cancel this action.
set /p supportChoice=Choose an option (Y/N): 
if /i "%supportChoice%"=="Y" (
    start "" "https://support.microsoft.com/en-us/contactus"
) else (
...
echo           Is This Website Safe?
echo ========================================
echo 1. Check with tria.ge
echo 2. Check with www.virustotal.com
echo 3. Back to Next Page
echo ========================================
set /p safetyChoice=Choose an option (1-3): 

if "%safetyChoice%"=="1" (
    start "" "https://tria.ge/"
) else if "%safetyChoice%"=="2" (
    start "" "https://www.virustotal.com/"
) else if "%safetyChoice%"=="3" (
    goto next_page
) else (
...
:run_ipconfig
cls
echo WARNING: Running 'ipconfig' will expose your IP address to anyone who is watching your screen and Wi-Fi network.
echo Please read this carefully before proceeding.
echo Also " IPv4 Address" is your home adress Wifi IP Address
echo Are you sure you want to run ipconfig? (Y/N)
...
:search_youtube
cls
set /p songSearch=Enter the name of the song or artist you want to search for: 
if not "%songSearch%"=="" (
    start "" "https://www.youtube.com/results?search_query=%songSearch%"
) else (
...
echo 13. Destroy: WARNING: This will close Discord and exit the tool.
echo 14. Lock Screen: Locks your computer screen, requiring a password or PIN to unlock.
echo 15. Visit My GitHub Page: Opens my GitHub project page where you can view and contribute to my work.
echo 16. Encyclopedia: Allows you to add, view, and delete notes stored in the ur_data folder.
echo 17. Lyrics: Displays lyrics of songs.
echo 18. Downloads: Provides download options for various tools.
echo 19. Rights to be Forgotten: Deletes all personal data and removes the tool from your system.
echo 20. Next Page: Navigate to the next set of options.
echo 21. Search for Music on YouTube: Opens the YouTube search page for music.
echo 22. Run ipconfig: Displays the network configuration settings.
echo 23. Is this website safe?: Checks the safety of a specified website.
echo 24. Microsoft Support: Opens the Microsoft Support website for help and resources.
pause
goto menu
